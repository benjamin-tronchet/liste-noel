...
<div class="u-panel_content">
    ...
    <form action="<?=SITE_MAIN_BASE.'user/update/'?>" method="POST" class="c-form" is-checked enctype="multipart/form-data">
        ...
        <div class="c-form_field">
            ...
            <input name="required[alphanum][username]" data-required="Indique un nom d'utilisateur" placeholder="Ton nom d'utilisateur" type="text" autocomplete="off" data-verification="user-username" value="<?=$user->username()?>">
        </div>
